"""Filling missing values in based on Multivariate Approach:
...
columns = ['Price','Living area','Building Cond. values', 'Number of facades', 'Kitchen values', 'Surface of the land', 'Primary energy consumption', 'Energy efficiency', 'Terrace','Terrace surface','Garden', 'Garden surface']
